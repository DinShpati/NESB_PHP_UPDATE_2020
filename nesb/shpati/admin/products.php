...
?>  
   <h2>Products</h2>
            ...
            <div class="section1 col-2">
                <div>
                    <a href="includes/insertProducts.php" class="createBtn">Create a New Product &nbsp;<i class="fas fa-plus-circle"></i></a>
                </div>
                <div>
                ...
                <div class="productTable">
                    ...
                    <div class="productRow">
                        ...
                        <div style="display: flex; justify-content: space-around;">
                            <a href="./includes/editProducts.php?edit_pro=<?php echo $pro_id; ?>" class="edit createBtn"><i class="far fa-edit"></i></a>
